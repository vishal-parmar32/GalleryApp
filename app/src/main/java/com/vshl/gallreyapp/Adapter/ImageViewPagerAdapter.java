...
public class ImageViewPagerAdapter extends FragmentPagerAdapter {
    public ArrayList<ImagesModel> arrayList = new ArrayList<>();
    public static Activity activity;

    public ImageViewPagerAdapter(@NonNull FragmentManager fm, ArrayList<ImagesModel> arrayList) {
        super(fm);
    ...
    public Fragment getItem(int position) {
        return PlaceholderFragment.newInstance(position, arrayList.get(position).getImageurl());
    }
